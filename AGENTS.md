...
- Current implementation scope is `SPY` EOD plus local `SPY` M1 enrichment. M1 live download and tick data should remain separate loaders under `src/thetadata_pipeline/loaders/`.
